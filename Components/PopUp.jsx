...
const PopUp = ({ setOpenModel, donate, donateFunction }) => {
  ...
  useEffect(() => {
    const fetchDonations = async () => {
      try {
        const donationData = await donateFunction(donate.pId);
    ...
    fetchDonations();
  }, [donate, donateFunction]);

  return (
    <>
      {/* Your popup JSX */}
      <div className="justify-center items-center flex overfloe-x-hidden 
              ...
              w-full bg-white outline-none focus:outline-none'>
                ...
                <div className='relative p-6 flex-auto'>
                  ...
                  border-slate-200 rounded-b'>
                    ...
                    <button
                    className='background text-white active:bg-emerald-600
